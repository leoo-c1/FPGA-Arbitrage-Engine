...
## Overview
This project implements a hardware-based execution engine that can detect and act on latency arbitrage opportunities in real-time. The system simulated two stock exchanges, Exchange A and Exchange B, which stream historical [market data](https://github.com/leoo-c1/FPGA-Arbitrage-Engine/tree/main/data) for Western Digital (WDC) on the tick level.
